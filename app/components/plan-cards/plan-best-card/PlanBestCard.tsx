  ...
  return (
    <>
      ...
      <label
        htmlFor={values.id}
        className={cn(
          "xs:h-[131px] xs:p-[18px_31px_20px_28px] xs:w-[343px] relative flex h-[118px] w-[288px] cursor-pointer overflow-hidden rounded-[20px] border-[2px] bg-[var(--bg-card)] p-[18px_9px_20px_18px] shadow-amber-400 hover:shadow-2xs md:h-[190px] md:w-full md:rounded-[34px] md:p-[34px_80px_30px_122px]",
          isSelected ? "border-[var(--accent)]" : "border-[var(--outline)]",
        )}
      >
        <div
          className={cn(
            "xs:right-[62px] absolute -top-[2px] right-[50px] md:left-[49px]",
            !isSale &&
